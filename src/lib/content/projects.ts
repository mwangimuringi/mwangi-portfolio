...
export const projectsSection: ProjectsSectionType = {
    ...
    projects: [
    {
        id: getId(),
        name: 'Urban wheels',
        url: 'https://urbanwheels.vercel.app/',
        repo: 'https://github.com/mwangimuringi/urbanwheels',
    ...
    },
    {
        id: getId(),
        name: 'BabaCare',
        url: 'https://babacare.vercel.app/',
        repo: 'https://github.com/mwangimuringi/babacare',
        img: 'https://user-images.githubusercontent.com/68834718/258852895-df5c6da7-a698-40fb-97c3-a5474314cb85.png',
        year: 2023,
        tags: ['Javascript', 'NextJs', 'TailwindCSS', 'Express'],
    },
    {
        id: getId(),
        name: 'ViatuPoa',
        url: 'https://viatupoa.vercel.app/',
        repo: 'https://github.com/mwangimuringi/viatupoa',
        ...
        year: 2023,
        tags: ['Typescript', 'Supabase', 'NextJs'],
    },
    {
        id: getId(),
        name: 'KahawaYetu',
        url: 'https://kahawayetu.vercel.app/',
        repo: 'https://github.com/mwangimuringi/kahawayetu',
        img: 'https://user-images.githubusercontent.com/68834718/189035104-aa71647e-33e4-442a-a2f9-c0d50bba2db1.png',
        year: 2024,
        tags: ['Nextjs', 'TailwindCSS', 'Prisma', 'GraphQL'],
    },
    {
        id: getId(),
        name: 'BlogNest',
        url: 'https://blognest.vercel.app/',
        repo: 'https://github.com/mwangimuringi/blognest',
        img: 'https://user-images.githubusercontent.com/68834718/169527851-19fefb2e-e440-411a-a8a1-4767e2c8688a.png',
        year: 2024,
        tags: ['NextJs', 'TypeScript', 'TailwindCSS', 'Drizzle', 'Stripe'],
    },
    {
        id: getId(),
