...
export const seoData = {
  title: 'Julius Mwangi | Fullstack Developer',
  description:
    'Julius Mwangi is a fullstack developer who specializes in building (and occasionally designing) exceptional visual interfaces.',
  author: author.name,
  image:
